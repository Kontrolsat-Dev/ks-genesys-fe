...
│  │  │  ├─ active-offer
│  │  │  │  ├─ components
│  │  │  │  │  ├─ active-offer-filters-bar.tsx
│  │  │  │  │  ├─ active-offer-table.tsx
│  │  │  │  │  └─ index.ts
│  │  │  │  ├─ index.tsx
│  │  │  │  └─ queries.ts
│  │  │  └─ catalog
│  │  │     ├─ components
│  │  │     │  ├─ catalog-filters-bar.tsx
│  │  │     │  ├─ catalog-table.tsx
│  │  │     │  └─ index.ts
│  │  │     ├─ index.tsx
│  │  │     └─ queries.ts
...
│  │        │  ├─ status-badge.tsx
│  │        │  ├─ utils.ts
│  │        │  ├─ worker-jobs-filters.tsx
│  │        │  ├─ worker-jobs-pagination.tsx
│  │        │  └─ worker-jobs-table.tsx
│  │        ├─ index.tsx
│  │        └─ queries.ts
│  ├─ helpers
│  │  ├─ fmtDate.ts
